...
";
            ...
            public ShaderV2()
            {
                CompileLink(vertex: vcode, frag: fcode, geo: "TestOpenTk.volumetricgeo2.glsl");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            dataoutbuffer.Allocate(sizeof(float) * 32, OpenTK.Graphics.OpenGL4.BufferUsageHint.DynamicRead);
        ...
        private void ControllerDraw(MatrixCalc mc, long time)
        {
            ...
            float[] databack = dataoutbuffer.ReadFloats(0, 12);
            for (int i = 0; i < databack.Length; i++)
            {
                System.Diagnostics.Debug.WriteLine(i + " = " + databack[i]);
            }
