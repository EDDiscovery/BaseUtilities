...
namespace BaseUtils
{
    public class Matrices<T>
    {
        ...
        public static Matrices<T> operator |(Matrices<T> m1, Matrices<T> m2)
        {
            var m = new Matrices<T>(m1.rows, m1.columns + m2.columns);
        ...
        public static Matrices<T> operator *(Matrices<T> m1, Matrices<T> m2)
        {
            var m = new Matrices<T>(m1.rows, m2.columns);
        ...
        public static Matrices<T> operator ~(Matrices<T> m)
        {
            var tmp = new Matrices<T>(m.columns, m.rows);
            for (int r = 0; r < m.rows; r++)
            {
                for (int c = 0; c < m.columns; c++)
                {
